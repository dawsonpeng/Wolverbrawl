...
Primarily students who enjoy competitive and casual multiplayer games
...
First team to lose all players is eliminated and loses

Protect the Student

Each team has a student taking a test

Opposing teams attempt to distract (attack) the other team’s student

Teams must defend their own student while disrupting the enemy’s
...
Gain and lose trophies based on performance

Earn resources by playing

Resources act as currency for upgrades

Unlockables (If Allowed)
...
Sprite sheet–based animations OR

Characters built with separate components:
...
Mix of artistic and technical animation work
...
Designed for keyboard or controller input
